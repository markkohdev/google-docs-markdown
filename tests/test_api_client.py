...
class TestAuthentication:
    ...
    def test_get_credentials_success(self, mock_default):
...
class TestGetDocument:
    ...
    def test_get_document_success(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_document_with_url(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_document_include_tabs_false(self, mock_build):
...
class TestMultiTabDetection:
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_is_multi_tab_true(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_is_multi_tab_false(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_is_multi_tab_no_tabs_key(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_tabs_multi_tab(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_tabs_single_tab(self, mock_build):
...
class TestRetryLogic:
    ...
    @patch("google_docs_markdown.api_client.build")
    @patch("time.sleep")
    def test_retry_on_retryable_error(self, mock_sleep, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    @patch("time.sleep")
    def test_no_retry_on_non_retryable_error(self, mock_sleep, mock_build):
...
class TestDocumentTitle:
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_document_title(self, mock_build):
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_get_document_title_missing(self, mock_build):
...
class TestCreateDocument:
    ...
    @patch("google_docs_markdown.api_client.build")
    def test_create_document(self, mock_build):
